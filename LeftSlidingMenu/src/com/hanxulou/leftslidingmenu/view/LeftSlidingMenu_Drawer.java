...
public class LeftSlidingMenu_Drawer extends HorizontalScrollView {
	...
	//使用了自定义属性时调用此构造方法
	public LeftSlidingMenu_Drawer(Context context, AttributeSet attrs, int defStyle) {
	...
	public LeftSlidingMenu_Drawer(Context context) {
		this(context, null);//调用两个参数的构造方法
	}

	//没有使用自定义属性时调用此构造方法
	public LeftSlidingMenu_Drawer(Context context, AttributeSet attrs) {
	...
	protected void onScrollChanged(int l, int t, int oldl, int oldt) {
		 ...
		 */
		ViewHelper.setTranslationX(mMenu, mMenuWidth * distance);//这里translationX的值则为mMenuWidth~0即隐藏的宽度变化值
//		Log.e("------ l: ---------", String.valueOf(l));
//		Log.e("------ translationX: ---------", String.valueOf(mMenuWidth * distance));
